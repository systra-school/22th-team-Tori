          ...
          <div style="margin-left:50px;">
            ...
            <table width="1300px" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top"><!-- valign="top"追加　2/27　木島  -->
                  <div style="overflow-x: auto;overflow-y: ; width:985px;height: text-align:center;">
                    <table class="tblHeader" border="1" cellpadding="0" cellspacing="0">
                      <tr height="<%=heightSize %>px">
      ...
      <div id="footer" style="margin-top:-50px;">
        <table>
          <tr>
            ...
            <td style="float: left;"> <%-- 障害表58対応 3/4 白石 --%>
            	 <input value="基本シフト反映" type="button" class="lngButton" onclick="submitHanei()" />
            </td>
            <td style="float: left;">　<!-- 繁栄→反映、誤字修正、2/28有吉 --> <%-- 障害表58対応 3/4 白石 --%>
