...
public class ShiftMstMntLogic {
     ...
     * @author naraki
     */
    public void registMshain(ShiftMstMntDto shiftMstMntDto, LoginUserDto loginUserDto) throws Exception{

        // シフトマスタDao
        ShiftMstMntDao shainMstMntDao = new ShiftMstMntDao();
        ...
        // 登録
        shainMstMntDao.registShiftMst(shiftMstMntDto, loginUserDto);
