...
public class RequestSessionNameConstant {
    ...
    /** ログインユーザの権限ID */
    public static final String SESSION_CMN_LOGIN_USER_KENGEN_ID = "session_cmn_login_user_kengen_id";

    /************* 社員マスタメンテナンス画面 ****************/

    /** 社員マスタメンテナンス画面 社員情報リスト */
    public static final String SESSION_MTH_SHAIN_MST_MNT_INFO_LIST = "session_mth_shain_mst_mnt_info_list";

    /************* リクエスト ****************/
    public static final String REQUEST_BACK_PAGE = "request_mth_shain_mst_mnt_info_list";
