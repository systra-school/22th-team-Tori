/**
 * ファイル名：TsukibetsuShiftKakuninForm.java
 *
 * 変更履歴
 ...
 *
 */
public class TsukibetsuShiftKakuninForm extends ActionForm {

    /** 出勤希望入力リスト */
    private List<TsukibetsuShiftKakuninBean> tsukibetsuShiftKakuninBeanList;
    /** 日付リスト */
     ...
     */
    public List<TsukibetsuShiftKakuninBean> getTsukibetsuShiftKakuninBeanList() {
        return tsukibetsuShiftKakuninBeanList;
    }
    /**
     * @param tsukibetsuShiftKakuninBeanList をセットする
     */
    public void setTsukibetsuShiftKakuninBeanList(
            List<TsukibetsuShiftKakuninBean> tsukibetsuShiftKakuninBeanList) {
        this.tsukibetsuShiftKakuninBeanList = tsukibetsuShiftKakuninBeanList;
    }
